...
if(typeof(jQuery)==='undefined'){var jQuery;if(typeof(require)==='function'){jQuery=$=require('jquery')}else{jQuery=$}};jQuery.easing.jswing=jQuery.easing.swing;jQuery.extend(jQuery.easing,{def:'easeOutQuad',swing:function(x,t,b,c,d){return jQuery.easing[jQuery.easing.def](x,t,b,c,d)},easeInQuad:function(x,t,b,c,d){return c*(t/=d)*t+b},easeOutQuad:function(x,t,b,c,d){return-c*(t/=d)*(t-2)+b},easeInOutQuad:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t+b;return-c/2*((--t)*(t-2)-1)+b},easeInCubic:function(x,t,b,c,d){return c*(t/=d)*t*t+b},easeOutCubic:function(x,t,b,c,d){return c*((t=t/d-1)*t*t+1)+b},easeInOutCubic:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t+b;return c/2*((t-=2)*t*t+2)+b},easeInQuart:function(x,t,b,c,d){return c*(t/=d)*t*t*t+b},easeOutQuart:function(x,t,b,c,d){return-c*((t=t/d-1)*t*t*t-1)+b},easeInOutQuart:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t+b;return-c/2*((t-=2)*t*t*t-2)+b},easeInQuint:function(x,t,b,c,d){return c*(t/=d)*t*t*t*t+b},easeOutQuint:function(x,t,b,c,d){return c*((t=t/d-1)*t*t*t*t+1)+b},easeInOutQuint:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t*t+b;return c/2*((t-=2)*t*t*t*t+2)+b},easeInSine:function(x,t,b,c,d){return-c*Math.cos(t/d*(Math.PI/2))+c+b},easeOutSine:function(x,t,b,c,d){return c*Math.sin(t/d*(Math.PI/2))+b},easeInOutSine:function(x,t,b,c,d){return-c/2*(Math.cos(Math.PI*t/d)-1)+b},easeInExpo:function(x,t,b,c,d){return(t==0)?b:c*Math.pow(2,10*(t/d-1))+b},easeOutExpo:function(x,t,b,c,d){return(t==d)?b+c:c*(-Math.pow(2,-10*t/d)+1)+b},easeInOutExpo:function(x,t,b,c,d){if(t==0)return b;if(t==d)return b+c;if((t/=d/2)<1)return c/2*Math.pow(2,10*(t-1))+b;return c/2*(-Math.pow(2,-10*--t)+2)+b},easeInCirc:function(x,t,b,c,d){return-c*(Math.sqrt(1-(t/=d)*t)-1)+b},easeOutCirc:function(x,t,b,c,d){return c*Math.sqrt(1-(t=t/d-1)*t)+b},easeInOutCirc:function(x,t,b,c,d){if((t/=d/2)<1)return-c/2*(Math.sqrt(1-t*t)-1)+b;return c/2*(Math.sqrt(1-(t-=2)*t)+1)+b},easeInElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*.3;if(a<Math.abs(c)){a=c;var s=p/4}
    ...
    if(object.parent().hasClass('active')){object.siblings('.collapsible-body').stop(!0,!1).slideDown({duration:350,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','')}})}
    else{object.siblings('.collapsible-body').stop(!0,!1).slideUp({duration:350,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','')}})}
    ...
    $this.on('click.collapse','> li > .collapsible-header',function(e){var element=$(e.target);if(isChildrenOfPanelHeader(element)){element=getPanelHeader(element)}
        element.toggleClass('active');collapsibleOpen(element)});if(options.accordion||collapsible_type==="accordion"||collapsible_type===undefined){collapsibleOpen($panel_headers.filter('.active').first())}else{$panel_headers.filter('.active').each(function(){collapsibleOpen($(this))})}})};$(document).ready(function(){$('.collapsible').collapsible()});$.fn.collapsibletable=function(options){var defaults={accordion:undefined,onOpen:undefined,onClose:undefined};options=$.extend(defaults,options);return this.each(function(){var $this=$(this);var $panel_headers=$(this).find('> tbody > .collapsible-header');var collapsible_type=$this.data("collapsible");$this.off('click.collapse','> tbody > .collapsible-header');$panel_headers.off('click.collapse');function accordionOpen(object){$panel_headers=$this.find('> tbody > .collapsible-header');if(object.hasClass('active')){object.parent().addClass('active')}
else{object.parent().removeClass('active')}
    if(object.parent().hasClass('active')){object.siblings('.collapsible-body').stop(!0,!1).slideDown({duration:1,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','')}})}
    else{object.siblings('.collapsible-body').stop(!0,!1).slideUp({duration:1,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','')}})}
    $panel_headers.not(object).removeClass('active').parent().removeClass('active');$panel_headers.not(object).parent().children('.collapsible-body').stop(!0,!1).each(function(){if($(this).is(':visible')){$(this).slideUp({duration:350,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','');execCallbacks($(this).siblings('.collapsible-header'))}})}})}
    function expandableOpen(object){if(object.hasClass('active')){object.parent().addClass('active')}
    else{object.parent().removeClass('active')}
        if(object.parent().hasClass('active')){object.siblings('.collapsible-body').stop(!0,!1).slideDown({duration:1,easing:"easeOutQuart",queue:!1,complete:function(){$(this).css('height','')}})}
    ...
    function execCallbacks(object){if(object.hasClass('active')){if(typeof(options.onOpen)==="function"){options.onOpen.call(this,object.parent())}}else{if(typeof(options.onClose)==="function"){options.onClose.call(this,object.parent())}}}
    function isChildrenOfPanelHeader(object){var panelHeader=getPanelHeader(object);return panelHeader.length>0}
    function getPanelHeader(object){return object.closest('tbody > tr.collapsible-header')}
    $this.on('click.collapse','> tbody > .collapsible-header',function(e){var element=$(e.target);if(isChildrenOfPanelHeader(element)){element=getPanelHeader(element)}
        element.toggleClass('active');collapsibleOpen(element)});if(options.accordion||collapsible_type==="accordion"||collapsible_type===undefined){collapsibleOpen($panel_headers.filter('.active').first())}else{$panel_headers.filter('.active').each(function(){collapsibleOpen($(this))})}})};$(document).ready(function(){$('table.collapsible').collapsibletable()})}(jQuery));(function($){$.fn.scrollTo=function(elem){$(this).scrollTop($(this).scrollTop()-$(this).offset().top+$(elem).offset().top);return this};$.fn.dropdown=function(options){var defaults={inDuration:300,outDuration:225,constrainWidth:!0,hover:!1,gutter:0,belowOrigin:!1,alignment:'left',stopPropagation:!1};if(options==="open"){this.each(function(){$(this).trigger('open')});return!1}
    if(options==="close"){this.each(function(){$(this).trigger('close')});return!1}
    this.each(function(){var origin=$(this);var curr_options=$.extend({},defaults,options);var isFocused=!1;var activates=$("#"+origin.attr('data-activates'));function updateOptions(){if(origin.data('induration')!==undefined)
        ...
        updateOptions();origin.after(activates);function placeDropdown(eventType){if(eventType==='focus'){isFocused=!0}
            updateOptions();activates.addClass('active');origin.addClass('active');if(curr_options.constrainWidth===!0){activates.css('width',origin.outerWidth())}else{activates.css('white-space','nowrap')}
            ...
            activates.css({position:'absolute',top:origin.position().top+verticalOffset+scrollYOffset,left:leftPosition+scrollXOffset});activates.stop(!0,!0).css('opacity',0).slideDown({queue:!1,duration:curr_options.inDuration,easing:'easeOutCubic',complete:function(){$(this).css('height','')}}).animate({opacity:1},{queue:!1,duration:curr_options.inDuration,easing:'easeOutSine'});$(document).bind('click.'+activates.attr('id')+' touchstart.'+activates.attr('id'),function(e){if(!activates.is(e.target)&&!origin.is(e.target)&&(!origin.find(e.target).length)){hideDropdown();$(document).unbind('click.'+activates.attr('id')+' touchstart.'+activates.attr('id'))}})}
        function hideDropdown(){isFocused=!1;activates.fadeOut(curr_options.outDuration);activates.removeClass('active');origin.removeClass('active');$(document).unbind('click.'+activates.attr('id')+' touchstart.'+activates.attr('id'));setTimeout(function(){activates.css('max-height','')},curr_options.outDuration)}
        if(curr_options.hover){var open=!1;origin.unbind('click.'+origin.attr('id'));origin.on('mouseenter',function(e){if(open===!1){placeDropdown();open=!0}});origin.on('mouseleave',function(e){var toEl=e.toElement||e.relatedTarget;if(!$(toEl).closest('.dropdown-content').is(activates)){activates.stop(!0,!0);hideDropdown();open=!1}});activates.on('mouseleave',function(e){var toEl=e.toElement||e.relatedTarget;if(!$(toEl).closest('.dropdown-button').is(origin)){activates.stop(!0,!0);hideDropdown();open=!1}})}else{origin.unbind('click.'+origin.attr('id'));origin.bind('click.'+origin.attr('id'),function(e){if(!isFocused){if(origin[0]==e.currentTarget&&!origin.hasClass('active')&&($(e.target).closest('.dropdown-content').length===0)){e.preventDefault();if(curr_options.stopPropagation){e.stopPropagation()}
            placeDropdown('click')}
        else if(origin.hasClass('active')){hideDropdown();$(document).unbind('click.'+activates.attr('id')+' touchstart.'+activates.attr('id'))}}})}
        origin.on('open',function(e,eventType){placeDropdown(eventType)});origin.on('close',hideDropdown)})};$(document).ready(function(){$('.dropdown-button').dropdown()})}(jQuery));(function($){var _stack=0,_lastID=0,_generateID=function(){_lastID++;return 'materialize-modal-overlay-'+_lastID};var methods={init:function(options){var defaults={opacity:0.5,inDuration:350,outDuration:250,ready:undefined,complete:undefined,dismissible:!0,startingTop:'4%',endingTop:'10%'};options=$.extend(defaults,options);return this.each(function(){var $modal=$(this);var modal_id=$(this).attr("id")||'#'+$(this).data('target');var closeModal=function(){var overlayID=$modal.data('overlay-id');var $overlay=$('#'+overlayID);$modal.removeClass('open');$('body').css({overflow:'',width:''});$modal.find('.modal-close').off('click.close');$(document).off('keyup.modal'+overlayID);$overlay.velocity({opacity:0},{duration:options.outDuration,queue:!1,ease:"easeOutQuart"});var exitVelocityOptions={duration:options.outDuration,queue:!1,ease:"easeOutCubic",complete:function(){$(this).css({display:"none"});if(typeof(options.complete)==="function"){options.complete.call(this,$modal)}
    ...
    $modal.find(".modal-close").on('click.close',function(e){closeModal()});$overlay.css({display:"block",opacity:0});$modal.css({display:"block",opacity:0});$overlay.velocity({opacity:options.opacity},{duration:options.inDuration,queue:!1,ease:"easeOutCubic"});$modal.data('associated-overlay',$overlay[0]);var enterVelocityOptions={duration:options.inDuration,queue:!1,ease:"easeOutCubic",complete:function(){if(typeof(options.ready)==="function"){options.ready.call(this,$modal,$trigger)}}};if($modal.hasClass('bottom-sheet')){$modal.velocity({bottom:"0",opacity:1},enterVelocityOptions)}
    ...
    $(this).addClass('initialized');var overlayActive=!1;var doneAnimating=!0;var inDuration=275;var outDuration=200;var origin=$(this);var placeholder=$('<div></div>').addClass('material-placeholder');var originalWidth=0;var originalHeight=0;var ancestorsChanged;var ancestor;origin.wrap(placeholder);origin.on('click',function(){var placeholder=origin.parent('.material-placeholder');var windowWidth=window.innerWidth;var windowHeight=window.innerHeight;var originalWidth=origin.width();var originalHeight=origin.height();if(doneAnimating===!1){returnToOriginal();return!1}
        ...
        origin.css({position:'absolute','z-index':1000,'will-change':'left, top, width, height'}).data('width',originalWidth).data('height',originalHeight);var overlay=$('<div id="materialbox-overlay"></div>').css({opacity:0}).click(function(){if(doneAnimating===!0)
    ...
    $this.children("img").one("load",function(){updateParallax(!0)}).each(function(){if(this.complete)$(this).trigger("load")});$(window).scroll(function(){window_width=$(window).width();updateParallax(!1)});$(window).resize(function(){window_width=$(window).width();updateParallax(!1)})})}}(jQuery));(function($){var methods={init:function(options){var defaults={onShow:null,swipeable:!1,responsiveThreshold:Infinity,};options=$.extend(defaults,options);return this.each(function(){var $this=$(this),window_width=$(window).width();var $active,$content,$links=$this.find('li.tab a'),$tabs_width=$this.width(),$tabs_content=$(),$tabs_wrapper,$tab_width=Math.max($tabs_width,$this[0].scrollWidth)/$links.length,$indicator,index=prev_index=0,clicked=!1,clickedTimeout,transition=300;var calcRightPos=function(el){return $tabs_width-el.position().left-el.outerWidth()-$this.scrollLeft()};var calcLeftPos=function(el){return el.position().left+$this.scrollLeft()};var animateIndicator=function(prev_index){if((index-prev_index)>=0){$indicator.velocity({"right":calcRightPos($active)},{duration:transition,queue:!1,easing:'easeOutQuad'});$indicator.velocity({"left":calcLeftPos($active)},{duration:transition,queue:!1,easing:'easeOutQuad',delay:90})}else{$indicator.velocity({"left":calcLeftPos($active)},{duration:transition,queue:!1,easing:'easeOutQuad'});$indicator.velocity({"right":calcRightPos($active)},{duration:transition,queue:!1,easing:'easeOutQuad',delay:90})}};if(options.swipeable){if(window_width>options.responsiveThreshold){options.swipeable=!1}}
    ...
    $this.on('click','a',function(e){if($(this).parent().hasClass('disabled')){e.preventDefault();return}
        ...
        clicked=!0;$tabs_width=$this.width();$tab_width=Math.max($tabs_width,$this[0].scrollWidth)/$links.length;$active.removeClass('active');var $oldContent=$content
    ...
    newToast.style.opacity=0;Vel(newToast,{translateY:'-35px',opacity:1},{duration:300,easing:'easeOutCubic',queue:!1});var timeLeft=displayLength;var counterInterval;if(timeLeft!=null){counterInterval=setInterval(function(){if(newToast.parentNode===null)
    ...
    if(menu.hasClass('fixed')){$(window).resize(function(){if(window.innerWidth>992){if($('#sidenav-overlay').length!==0&&menuOut){removeMenu(!0)}
    else{menu.css('transform','translateX(0%)')}}
    else if(menuOut===!1){if(options.edge==='left'){menu.css('transform','translateX(-100%)')}else{menu.css('transform','translateX(100%)')}}})}
    if(options.closeOnClick===!0){menu.on("click.itemclick","a:not(.collapsible-header)",function(){removeMenu()})}
    var removeMenu=function(restoreNav){panning=!1;menuOut=!1;$('body').css({overflow:'',width:''});$('#sidenav-overlay').velocity({opacity:0},{duration:200,queue:!1,easing:'easeOutQuad',complete:function(){$(this).remove()}});if(options.edge==='left'){$dragTarget.css({width:'',right:'',left:'0'});menu.velocity({'translateX':'-100%'},{duration:200,queue:!1,easing:'easeOutCubic',complete:function(){if(restoreNav===!0){menu.removeAttr('style');menu.css('width',options.menuWidth)}}})}
    else{$dragTarget.css({width:'',right:'0',left:''});menu.velocity({'translateX':'100%'},{duration:200,queue:!1,easing:'easeOutCubic',complete:function(){if(restoreNav===!0){menu.removeAttr('style');menu.css('width',options.menuWidth)}}})}};var panning=!1;var menuOut=!1;if(options.draggable){$dragTarget.on('click',function(){if(menuOut){removeMenu()}});$dragTarget.hammer({prevent_default:!1}).bind('pan',function(e){if(e.gesture.pointerType=="touch"){var direction=e.gesture.direction;var x=e.gesture.center.x;var y=e.gesture.center.y;var velocityX=e.gesture.velocityX;var $body=$('body');var $overlay=$('#sidenav-overlay');var oldWidth=$body.innerWidth();$body.css('overflow','hidden');$body.width(oldWidth);if($overlay.length===0){$overlay=$('<div id="sidenav-overlay"></div>');$overlay.css('opacity',0).click(function(){removeMenu()});$('body').append($overlay)}
        ...
        else{if(x<(window.innerWidth-options.menuWidth/2)){menuOut=!0}
        ...
        var overlayPerc;if(options.edge==='left'){overlayPerc=x/options.menuWidth;$overlay.velocity({opacity:overlayPerc},{duration:10,queue:!1,easing:'easeOutQuad'})}
        else{overlayPerc=Math.abs((x-window.innerWidth)/options.menuWidth);$overlay.velocity({opacity:overlayPerc},{duration:10,queue:!1,easing:'easeOutQuad'})}}}).bind('panend',function(e){if(e.gesture.pointerType=="touch"){var $overlay=$('<div id="sidenav-overlay"></div>');var velocityX=e.gesture.velocityX;var x=e.gesture.center.x;var leftPos=x-options.menuWidth;var rightPos=x-options.menuWidth/2;if(leftPos>0){leftPos=0}
        ...
        panning=!1;if(options.edge==='left'){if((menuOut&&velocityX<=0.3)||velocityX<-0.5){if(leftPos!==0){menu.velocity({'translateX':[0,leftPos]},{duration:300,queue:!1,easing:'easeOutQuad'})}
            $overlay.velocity({opacity:1},{duration:50,queue:!1,easing:'easeOutQuad'});$dragTarget.css({width:'50%',right:0,left:''});menuOut=!0}
        else if(!menuOut||velocityX>0.3){$('body').css({overflow:'',width:''});menu.velocity({'translateX':[-1*options.menuWidth-10,leftPos]},{duration:200,queue:!1,easing:'easeOutQuad'});$overlay.velocity({opacity:0},{duration:200,queue:!1,easing:'easeOutQuad',complete:function(){$(this).remove()}});$dragTarget.css({width:'10px',right:'',left:0})}}
        else{if((menuOut&&velocityX>=-0.3)||velocityX>0.5){if(rightPos!==0){menu.velocity({'translateX':[0,rightPos]},{duration:300,queue:!1,easing:'easeOutQuad'})}
            $overlay.velocity({opacity:1},{duration:50,queue:!1,easing:'easeOutQuad'});$dragTarget.css({width:'50%',right:'',left:0});menuOut=!0}
        else if(!menuOut||velocityX<-0.3){$('body').css({overflow:'',width:''});menu.velocity({'translateX':[options.menuWidth+10,rightPos]},{duration:200,queue:!1,easing:'easeOutQuad'});$overlay.velocity({opacity:0},{duration:200,queue:!1,easing:'easeOutQuad',complete:function(){$(this).remove()}});$dragTarget.css({width:'10px',right:0,left:''})}}}})}
    $this.off('click.sidenav').on('click.sidenav',function(){if(menuOut===!0){menuOut=!1;panning=!1;removeMenu()}
    else{var $body=$('body');var $overlay=$('<div id="sidenav-overlay"></div>');var oldWidth=$body.innerWidth();$body.css('overflow','hidden');$body.width(oldWidth);$('body').append($dragTarget);if(options.edge==='left'){$dragTarget.css({width:'50%',right:0,left:''});menu.velocity({'translateX':[0,-1*options.menuWidth]},{duration:300,queue:!1,easing:'easeOutQuad'})}
    else{$dragTarget.css({width:'50%',right:'',left:0});menu.velocity({'translateX':[0,options.menuWidth]},{duration:300,queue:!1,easing:'easeOutQuad'})}
        $overlay.css('opacity',0).click(function(){menuOut=!1;panning=!1;removeMenu();$overlay.velocity({opacity:0},{duration:300,queue:!1,easing:'easeOutQuad',complete:function(){$(this).remove()}})});$('body').append($overlay);$overlay.velocity({opacity:1},{duration:300,queue:!1,easing:'easeOutQuad',complete:function(){menuOut=!0;panning=!1}})}
        return!1})})},destroy:function(){var $overlay=$('#sidenav-overlay');var $dragTarget=$('.drag-target[data-sidenav="'+$(this).attr('data-activates')+'"]');$overlay.trigger('click');$dragTarget.remove();$(this).off('click');$overlay.remove()},show:function(){this.trigger('click')},hide:function(){$('#sidenav-overlay').trigger('click')}};$.fn.sideNav=function(methodOrOptions){if(methods[methodOrOptions]){return methods[methodOrOptions].apply(this,Array.prototype.slice.call(arguments,1))}else if(typeof methodOrOptions==='object'||!methodOrOptions){return methods.init.apply(this,arguments)}else{$.error('Method '+methodOrOptions+' does not exist on jQuery.sideNav')}}}(jQuery));(function($){var jWindow=$(window);var elements=[];var elementsInView=[];var isSpying=!1;var ticks=0;var unique_id=1;var offset={top:0,right:0,bottom:0,left:0,}
    ...
    $inputElement.siblings(selector).removeClass('active');validate_field($inputElement)});window.validate_field=function(object){var hasLength=object.attr('data-length')!==undefined;var lenAttr=parseInt(object.attr('data-length'));var len=object.val().length;if(object.val().length===0&&object[0].validity.badInput===!1){if(object.hasClass('validate')){object.removeClass('valid');object.removeClass('invalid')}}
    ...
    $select.addClass('initialized');$newSelect.on({'focus':function(){if($('ul.select-dropdown').not(options[0]).is(':visible')){$('input.select-dropdown').trigger('close')}
        if(!options.is(':visible')){$(this).trigger('open',['focus']);var label=$(this).val();if(multiple&&label.indexOf(',')>=0){label=label.split(',')[0]}
            var selectedOption=options.find('li').filter(function(){return $(this).text().toLowerCase()===label.toLowerCase()})[0];activateOption(options,selectedOption,!0)}},'click':function(e){e.stopPropagation()}});$newSelect.on('blur',function(){if(!multiple){$(this).trigger('close')}
    ...
    function captionTransition(caption,duration){if(caption.hasClass("center-align")){caption.velocity({opacity:0,translateY:-100},{duration:duration,queue:!1})}
    ...
    $active.find('img').each(function(){$active.find('.caption').velocity({opacity:1,translateX:0,translateY:0},{duration:options.transition,queue:!1,easing:'easeOutQuad'})});$interval=setInterval(function(){$active_index=$slider.find('.active').index();moveToSlide($active_index+1)},options.transition+options.interval);var panning=!1;var swipeLeft=!1;var swipeRight=!1;$this.hammer({prevent_default:!1}).bind('pan',function(e){if(e.gesture.pointerType==="touch"){clearInterval($interval);var direction=e.gesture.direction;var x=e.gesture.deltaX;var velocityX=e.gesture.velocityX;var velocityY=e.gesture.velocityY;$curr_slide=$slider.find('.active');if(Math.abs(velocityX)>Math.abs(velocityY)){$curr_slide.velocity({translateX:x},{duration:50,queue:!1,easing:'easeOutQuad'})}
        ...
        if(swipeRight){next_slide=$curr_slide.prev();if(next_slide.length===0){next_slide=$slides.last()}
            next_slide.velocity({opacity:1},{duration:300,queue:!1,easing:'easeOutQuad'})}}}).bind('panend',function(e){if(e.gesture.pointerType==="touch"){$curr_slide=$slider.find('.active');panning=!1;curr_index=$slider.find('.active').index();if(!swipeRight&&!swipeLeft||$slides.length<=1){$curr_slide.velocity({translateX:0},{duration:300,queue:!1,easing:'easeOutQuad'})}
...
else if($(e.target).is($('.card .activator'))||$(e.target).is($('.card .activator i'))){$(e.target).closest('.card').css('overflow','hidden');$(this).find('.card-reveal').css({display:'block'}).velocity("stop",!1).velocity({translateY:'-100%'},{duration:300,queue:!1,easing:'easeInOutQuad'})}}})})}(jQuery));(function($){var materialChipsDefaults={data:[],placeholder:'',secondaryPlaceholder:'',autocompleteData:{},autocompleteLimit:Infinity,};$(document).ready(function(){$(document).on('click','.chip .close',function(e){var $chips=$(this).closest('.chips');if($chips.attr('data-initialized')){return}
    ...
    if(e.gesture.pointerType==="touch"){var $this=$(this);if(swipeLeft||swipeRight){var fullWidth;if(swipeLeft){fullWidth=$this.innerWidth()}
        ...
        $this.velocity({translateX:fullWidth,},{duration:100,queue:!1,easing:'easeOutQuad',complete:function(){$this.css('border','none');$this.velocity({height:0,padding:0,},{duration:200,queue:!1,easing:'easeOutQuad',complete:function(){$this.remove()}})}})}
    else{$this.velocity({translateX:0,},{duration:100,queue:!1,easing:'easeOutQuad'})}
    ...
    setTimeout(throttledScroll,0)}})(jQuery);(function(factory){if(typeof define=='function'&&define.amd)
    ...
    function PickerConstructor(ELEMENT,NAME,COMPONENT,OPTIONS){if(!ELEMENT)return PickerConstructor
        ...
        function prepareElementRoot(){P.$root.on({keydown:handleKeydownEvent,focusin:function(event){P.$root.removeClass(CLASSES.focused)
            ...
            else if(targetData.clear){P.clear().close(!0)}
    ...
    function click(e){if(dragged){e.preventDefault();e.stopPropagation();return!1}else if(!options.fullWidth){var clickedIndex=$(e.target).closest('.carousel-item').index();var diff=(center%count)-clickedIndex;if(diff!==0){e.preventDefault();e.stopPropagation()}
