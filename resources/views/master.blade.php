    ...
    <body data-lang="{{ Auth::user()->locale }}">
        ...
        <header>
            ...
            <ul id="nav-mobile" class="side-nav fixed">
                ...
                <li><a href="https://github.com/matthenning/ciliatus/releases/tag/v1.1-beta" class="waves-effect waves-teal"><i class="material-icons">linear_scale</i>Version v1.1-beta dev</a></li>
                @endif
