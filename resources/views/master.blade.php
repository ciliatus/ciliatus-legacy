    ...
    <body data-lang="{{ Auth::user()->locale }}" style="height: 100%;">
        ...
        <header>
            ...
            <ul id="nav-mobile" class="side-nav fixed">
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li @if(Request::is('generic_component_types/' . $gct->id, 'generic_component_types/' . $gct->id . '/*')) class="active" @endif>
                                        <a href="{{ url('generic_component_types/' . $gct->id) }}" class="waves-effect waves-teal">
                ...
                <li><a href="https://github.com/matthenning/ciliatus/releases/tag/v1.5-beta" class="waves-effect waves-teal"><i class="material-icons">linear_scale</i>Version v1.6-beta dev</a></li>
                @endif
