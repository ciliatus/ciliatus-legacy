                ...
                <form class="form-horizontal form-label-left" name="f_create_terra" action="{{ url('api/v1/terraria') }}" data-method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" placeholder="@lang('labels.name')" name="f_create_terra_displayname" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <button type="submit" class="btn btn-success" name="f_edit_terra_submit">@lang('buttons.next')</button>
                        </div>
                    </div>
