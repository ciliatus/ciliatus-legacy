...
@section('content')
    ...
    <div id="tab_overview" class="col s12">
        ...
        <div class="fixed-action-btn">
            ...
            <ul>
                <li><a class="btn-floating orange tooltipped" data-position="left" data-delay="50" data-tooltip="@lang('tooltips.floating.edit')"href="/logical_sensors/{{ $logical_sensor->id }}/edit"><i class="material-icons">edit</i></a></li>
