@foreach ($logical_sensors as $ls)
    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 dashboard-box" id="logical_sensor-{{ $ls->id }}">
        <div class="x_panel">
            ...
            <div class="x_title">
                <h2><a href="{{ url('logical_sensors/' . $ls->id) }}">{{ $ls->name }}</a></h2>
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="{{ url('logical_sensors/' . $ls->id . '/edit') }}">@lang('menu.edit')</a>
                            </li>
                            <li>
                                <a href="{{ url('logical_sensors/' . $ls->id . '/delete') }}">@lang('menu.delete')</a>
                            </li>
                        </ul>
                    </li>
                </ul>
