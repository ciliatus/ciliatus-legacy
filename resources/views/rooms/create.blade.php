...
@section('breadcrumbs')
    ...
    <a href="/rooms/create" class="breadcrumb hide-on-small-and-down">@lang('buttons.create')</a>
@stop
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l6">
                <div class="card">
                    <form action="{{ url('api/v1/rooms') }}" data-method="POST" data-redirect-success="auto">
