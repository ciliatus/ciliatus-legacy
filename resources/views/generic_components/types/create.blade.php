...
@section('content')
    <div class="container">
        <generic_component_type_create-form container-classes="row" wrapper-classes="col s12 m12 l10"
                                            :sensorreading-types="{{ $sensorreading_types }}"></generic_component_type_create-form>
    </div>
@stop