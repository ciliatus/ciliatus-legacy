...
@section('content')
    ...
    <div class="fixed-action-btn">
        ...
        <ul>
            <li><a class="btn-floating green tooltipped" data-position="left" data-delay="50" data-tooltip="@lang('tooltips.floating.add')" href="/generic_components/create?preset[generic_component_type_id]={{ $generic_component_type->id }}"><i class="mdi mdi-24px mdi-plus"></i></a></li>
        </ul>
    </div>
@stop