...
@section('breadcrumbs')
    ...
    <a href="/biography_entries/{{ $entry->id }}" class="breadcrumb">{{ $entry->display_name }}</a>
    <a href="/biography_entries/{{ $entry->id }}/delete" class="breadcrumb">@lang('buttons.delete')</a>
@stop
