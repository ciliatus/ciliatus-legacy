...
@section('breadcrumbs')
    ...
    <a href="/custom_component_types/{{ $type->id }}" class="breadcrumb hide-on-small-and-down">{{ $type->name_plural }}</a>
    <a href="/custom_components/create" class="breadcrumb hide-on-small-and-down">@lang('buttons.create')</a>
@stop
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l6">
                <div class="card">
                    <form action="{{ url('api/v1/custom_components') }}" data-method="POST" data-redirect-success="/custom_component_types/{{ $type->id }}">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <label for="type_name">@choice('labels.custom_component_types', 1)</label>
                                </div>
                            </div>
