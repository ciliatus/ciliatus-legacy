...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 col-xl-8">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" name="f_edit_user" action="{{ url('api/v1/users/' . $user->id) }}" data-method="PUT">

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">ID</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" readonly="readonly" placeholder="ID" name="id" value="{{ $user->id }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.name')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="@lang('labels.name')" name="name"
                               value="{{ $user->name }}" @if(Gate::denies('api-write:user_all')) readonly="readonly" @endif>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.email')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="@lang('labels.email')" name="email"
                               value="{{ $user->email }}" @if(Gate::denies('api-write:user_all')) readonly="readonly" @endif>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.language')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_multiple form-control" name="language">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@choice('labels.timezone', 2)</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_multiple form-control" name="timezone">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.notification_type')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12" style="padding-top: 6px;">
                        <div class="">
                            <label>
                                <input type="checkbox" class="js-switch" name="notifications_enabled" @if($user->setting('notifications_enabled') == true) checked @endif />
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.auto_nightmode')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12" style="padding-top: 6px;">
                        <div class="">
                            <label>
                                <input type="checkbox" class="js-switch" name="auto_nightmode_enabled" @if($user->setting('auto_nightmode_enabled') == true) checked @endif />
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('labels.permanent_nightmode')</label>
                    <div class="col-md-9 col-sm-9 col-xs-12" style="padding-top: 6px;">
                        <div class="">
                            <label>
                                <input type="checkbox" class="js-switch" name="permanent_nightmode_enabled" @if($user->setting('permanent_nightmode_enabled') == true) checked @endif />
                                <small>@lang('tooltips.disables_option', ['option' => trans('labels.auto_nightmode')])</small>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                @if(Gate::allows('api-write:user_all'))
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">@choice('labels.abilities', 2) <br /><small>@lang('tooltips.ctrltoselect')</small></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="select2_multiple form-control" multiple="multiple" name="abilities[]" style="height: 300px;">
