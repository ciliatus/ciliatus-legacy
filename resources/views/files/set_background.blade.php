    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m2 l2">
                ...
                <div class="center-align">
                    <strong>@lang('tooltips.set_as_background')</strong>
                </div>
            </div>
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-action">
                        <form action="{{ url('api/v1/files/set-background/' . $source->class . '/' . $source->id . '/' . $file->id) }}"
                              data-method="POST" data-redirect-success="{{ URL::previous() }}">
                            <div class="row">
                                <div class="input-field col s12">
