...
@section('content')
    <div class="col-md-6 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="material-icons">memory</i> @lang('labels.create') @choice('components.physical_sensors', 1)</h2>
            ...
            <div class="x_content">
                <br />
                <form class="form-horizontal form-label-left" name="sensor" action="{{ url('api/v1/physical_sensors') }}" data-method="POST">
