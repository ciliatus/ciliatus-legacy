    ...
    <div id="tab_overview" class="col s12">
        <div class="container">
            ...
            <div class="fixed-action-btn">
                ...
                <ul>
                    <li><a class="btn-floating orange tooltipped" data-position="left" data-delay="50" data-tooltip="@lang('tooltips.floating.edit')"href="/pumps/{{ $pump->id }}/edit"><i class="mdi mdi-24px mdi-pencil"></i></a></li>
                    <li><a class="btn-floating red tooltipped" data-position="left" data-delay="50" data-tooltip="@lang('tooltips.floating.delete')" href="/pumps/{{ $pump->id }}/delete"><i class="mdi mdi-24px mdi-delete"></i></a></li>
