...
@section('content')
    <div class="col-md-6 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="material-icons">rotate_right</i> {{ $pump->name }}</h2>
                ...
                <form class="form-horizontal form-label-left" name="f_delete_pumps" action="{{ url('api/v1/pumps/' . $pump->id) }}" data-method="DELETE">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" placeholder="Name" name="id" value="{{ $pump->id }}" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" placeholder="@lang('labels.name')" name="name" value="{{ $pump->name }}" readonly="readonly">
                        </div>
                    </div>
