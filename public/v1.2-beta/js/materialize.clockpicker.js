  ...
  function t(t) {
    ...
    function r(t, i) {
      var e = h.offset(),
          ...
          u = Math.sqrt(r * r + l * l),
          m = !1;if (!i || !(b - w > u || u > b + w)) {
        t.preventDefault();var v = setTimeout(function () {
          V.popover.addClass("clockpicker-moving");
        }, 200);p && h.append(V.canvas), V.setHand(r, l, !i, !0), a.off(d).on(d, function (t) {
          t.preventDefault();var i = /^touch/.test(t.type),
              e = (i ? t.originalEvent.touches[0] : t).pageX - o,
              s = (i ? t.originalEvent.touches[0] : t).pageY - c;(m || e !== r || s !== l) && (m = !0, V.setHand(e, s, !1, !0));
        }), a.off(k).on(k, function (t) {
          a.off(k), t.preventDefault();var e = /^touch/.test(t.type),
              s = (e ? t.originalEvent.changedTouches[0] : t).pageX - o,
              p = (e ? t.originalEvent.changedTouches[0] : t).pageY - c;(i || m) && s === r && p === l && V.setHand(s, p), "hours" === V.currentView ? V.toggleView("minutes", A / 2) : n.autoclose && (V.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
            V.done();
    ...
    var t,
        i = document.createElement("div");return i.innerHTML = "<svg/>", t = (i.firstChild && i.firstChild.namespaceURI) == r, i.innerHTML = "", t;
  }(),
      l = function () {
    ...
    if (!this.isShown) {
      o(this.options.beforeShow), c(":input").each(function () {
        ...
        var i = c(t.target);0 === i.closest(e.popover.find(".picker__wrap")).length && 0 === i.closest(e.input).length && e.hide();
    ...
    var e = !1;"minutes" === t && "visible" === c(this.hoursView).css("visibility") && (o(this.options.beforeHourSelect), e = !0);var s = "hours" === t,
        n = s ? this.hoursView : this.minutesView,
        a = s ? this.minutesView : this.hoursView;this.currentView = t, this.spanHours.toggleClass("text-primary", s), this.spanMinutes.toggleClass("text-primary", !s), a.addClass("clockpicker-dial-out"), n.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(i), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
    ...
    var i = this.currentView,
        ...
        a = Math.sin(c) * n,
        r = -Math.cos(c) * n,
        l = this;p && t ? (l.canvas.addClass("clockpicker-canvas-out"), setTimeout(function () {
    ...
    var n,
      ...
      var t = c(this);t.toggleClass("active", n === +t.html());
    });o || !r && n % 5 ? (this.g.insertBefore(this.hand, this.bearing), this.g.insertBefore(this.bg, this.fg), this.bg.setAttribute("class", "clockpicker-canvas-bg clockpicker-canvas-bg-trans")) : (this.g.insertBefore(this.hand, this.bg), this.g.insertBefore(this.fg, this.bg), this.bg.setAttribute("class", "clockpicker-canvas-bg"));var v = Math.sin(a) * (k - w),
        f = -Math.cos(a) * (k - w),
        y = Math.sin(a) * k,
        A = -Math.cos(a) * k;this.hand.setAttribute("x2", v), this.hand.setAttribute("y2", f), this.bg.setAttribute("cx", y), this.bg.setAttribute("cy", A), this.fg.setAttribute("cx", y), this.fg.setAttribute("cy", A);
    ...
    var i = Array.prototype.slice.call(arguments, 1);return this.each(function () {
      var e = c(this),
        ...
        var n = c.extend({}, s.DEFAULTS, e.data(), "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && t);e.data("clockpicker", new s(e, n));
      }
    });
  };
}();
...
//# sourceMappingURL=materialize.clockpicker.js.map
